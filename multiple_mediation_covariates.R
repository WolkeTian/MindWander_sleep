...
multipleMediation <- '
Y ~ b1* M1 + b2*M2 + c*X + b3*E1 + b4*E2 + b5*E3 + b6*E4 + b7*E5
M1~ a1*X
M2~ a2 * X
indirect1 := a1*b1
indirect2 := a2 * b2
...
fit <- sem(model = multipleMediation, data = fullData, se = 'bootstrap', bootstrap = 10000)
summary(fit)
